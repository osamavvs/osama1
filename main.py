...
def send_welcome(message: Message):
    ...
    welcome_text = "مرحباً، أرسل رابط المنشور للرشق."
...
def handle_message(message: Message):
    ...
    try:
        ...
        if "success" in response.text.lower():
            ...
            bot.edit_message_text("❌ فشلت العملية. (الموقع قد لا يستجيب حالياً)", chat_id=message.chat.id, message_id=waiting_msg.message_id)
